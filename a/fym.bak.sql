...
-- ----------------------------
-- Table structure for fym_source_2
-- ----------------------------
DROP TABLE IF EXISTS `fym_source_2`;
CREATE TABLE `fym_source_2`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mkey` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `content` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `create_time` bigint(20) NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for fym_user_2
-- ----------------------------
DROP TABLE IF EXISTS `fym_user_2`;
CREATE TABLE `fym_user_2`  (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `detail` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for fym_user_detail_2
-- ----------------------------
DROP TABLE IF EXISTS `fym_user_detail_2`;
CREATE TABLE `fym_user_detail_2`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
